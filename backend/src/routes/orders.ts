...
import { validate, createOrderSchema, updateOrderSchema, updateOrderStatusSchema, paginationSchema, idParamSchema } from '../middleware/validation';
...
router.patch('/:id/status', requirePermission('orders:update'), validate(idParamSchema, 'params'), validate(updateOrderStatusSchema), updateOrderStatus);
