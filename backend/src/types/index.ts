...
export interface JwtPayload {
  ...
  export interface updatedInventoryItemDto {
    name?: string
    description?: string
    category?: string
    minStock?: number
  ...
  export interface GenerateDucomentDto {
    type: DocumentType
    orderId: string
  ...
  export interface OrderReport {
    ...
    orderByStatus: Record<OrderStatus, number>
    orderByCountry: Array<{country: string; count: number; revenue: number}>
