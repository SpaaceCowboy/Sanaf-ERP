...
export async function getOrderReport(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    const [
      ...
      prisma.$queryRaw<Array<{ date: Date; count: bigint; revenue: number }>>`
        SELECT 
...
export async function getInventoryReport(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    const [
      ...
      prisma.$queryRaw<[{ totalItems: bigint; totalQuantity: bigint; totalValue: number }]>`
        SELECT 
          COUNT(*) as "totalItems",
...
export async function getProjectReport(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    const [
      projectsByStatus,
      projectsByPriority,
      ...
      prisma.$queryRaw<[{ totalTasks: bigint; completedTasks: bigint }]>`
        SELECT 
          COUNT(*) as "totalTasks",
...
export async function getFinancialReport(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
