...
exports.generateProformaInvoicePdf = generateProformaInvoicePdf;
exports.generatePackingListPdf = generatePackingListPdf;
exports.generateCommercialInvoicePdf = generateCommercialInvoicePdf;
exports.generateCertificateOfOriginPdf = generateCertificateOfOriginPdf;
const pdfkit_1 = __importDefault(require("pdfkit"));
const path_1 = __importDefault(require("path"));
const fs_1 = __importDefault(require("fs"));
// Ensure uploads directory exists
const uploadsDir = path_1.default.join(process.cwd(), 'uploads', 'documents');
...
async function generateProformaInvoicePdf(order, proformaNumber) {
    return new Promise((resolve, reject) => {
...
async function generatePackingListPdf(order, packingNumber) {
    return new Promise((resolve, reject) => {
...
async function generateCommercialInvoicePdf(order, commercialInvoiceNumber) {
    return new Promise((resolve, reject) => {
...
async function generateCertificateOfOriginPdf(order, certificateNumber) {
    return new Promise((resolve, reject) => {
