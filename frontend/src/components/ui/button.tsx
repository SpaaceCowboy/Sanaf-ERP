...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]',
  {
    variants: {
      variant: {
        default:
          'bg-electric-600 text-white hover:bg-electric-500 shadow-md shadow-electric-900/20 hover:shadow-lg hover:shadow-electric-900/30',
        destructive:
          'bg-danger-600 text-white hover:bg-danger-500 shadow-md shadow-danger-900/20',
        outline:
        ...
        glow: 'bg-electric-600 text-white hover:bg-electric-500 shadow-glow hover:shadow-glow-lg',
      },
      size: {
